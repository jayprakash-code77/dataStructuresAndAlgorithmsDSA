...
public class ArrayList_Concepts {
   public static void main(String[] args) {
     ...
     * 4) ArrayList is created inside Heap
     * 5) Time complexity of insertion in ArrayList is O(n).
     * 6) Time complexity of search is O(1).
    */
   ...
   //  Operations on ArrayList
      ...
      // sorting is accending order
         Collections.sort(nameList);  // this will not work on array
         System.out.println(nameList);
