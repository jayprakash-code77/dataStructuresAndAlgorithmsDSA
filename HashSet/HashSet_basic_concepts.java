...
public class HashSet_basic_concepts {
    ...
    set.add(3);
    set.add(5);
    set.add(1); //this will not be added because, the duplicate of this already exits in the set
    ...
    Iterator name = set.iterator();  // "name" is pointing to the null value at first 
    // name.next();
    /*name.next();*/ // now "name" will point to the first value.

    // name.hasNext(); // This will "return false" if the set contains the next value else it will "return true".
    /*name.hasNext();*/
